...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__static_auth0__ = __webpack_require__("./static/auth0.js");
...
function (_React$Component) {
  ...
  _createClass(_default, [{
    ...
    value: function componentDidMount() {
      Object(__WEBPACK_IMPORTED_MODULE_2__static_auth0__["c" /* parseHash */])(function (err, result) {
        if (err) {
          console.error('Error signing in', err);
          return;
        }

        Object(__WEBPACK_IMPORTED_MODULE_3__static_auth__["e" /* verifyToken */])(result.idToken).then(function (valid) {
          if (valid) {
            Object(__WEBPACK_IMPORTED_MODULE_3__static_auth__["d" /* saveToken */])(result.idToken, result.accessToken);
...
module.exports = __webpack_require__("./pages/redirect.js");
